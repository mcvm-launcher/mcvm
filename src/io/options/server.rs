...
fn default_difficulty() -> EnumOrNumber<Difficulty> { EnumOrNumber::Enum(Difficulty::Easy) }
fn default_allow_command_blocks() -> bool { false }
fn default_jmx_monitoring() -> bool { false }
fn default_rcon_enable() -> bool { false }
fn default_rcon_port() -> u16 { 25575 }
fn default_rcon_password() -> Option<String> { None }
fn default_enable_status() -> bool { true }
fn default_query_enable() -> bool { false }
fn default_query_port() -> u16 { 25565 }
fn default_enforce_secure_profile() -> bool { true }
fn default_whitelist_enable() -> bool { false }
fn default_whitelist_enforce() -> bool { false }
fn default_entity_broadcast_range() -> u16 { 50 }
fn default_gamemode_default() -> EnumOrNumber<GameMode> { EnumOrNumber::Enum(GameMode::Survival) }
fn default_gamemode_force() -> bool { false }
fn default_datapacks_function_permission_level() -> u8 { 2 }
fn default_datapacks_initial_enabled() -> Vec<String> { vec![String::from("vanilla")] }
fn default_datapacks_initial_disabled() -> Vec<String> { vec![] }
fn default_hardcore() -> bool { false }
fn default_hide_online_players() -> bool { false }
fn default_world_name() -> String { String::from("world") }
fn default_world_seed() -> Option<String> { None }
fn default_world_type() -> EnumOrString<WorldType> { EnumOrString::Enum(WorldType::Normal) }
fn default_world_structures() -> bool { true }
fn default_world_generator_settings() -> json::JsonObject { json::empty_object() }
fn default_world_max_size() -> u32 { 29999984 }
fn default_world_max_build_height() -> u32 { 256 }
fn default_world_allow_nether() -> bool { true }
fn default_max_chained_neighbor_updates() -> i32 { 1000000 }
fn default_max_players() -> u32 { 20 }
fn default_max_tick_time() -> u64 { 60000 }
fn default_motd() -> String { String::from("A Minecraft Server") }
fn default_network_compression_threshold() -> EnumOrNumber<NetworkCompression> { EnumOrNumber::Num(256) }
fn default_offline_mode() -> bool { false }
fn default_op_permission_level() -> u8 { 4 }
fn default_player_idle_timeout() -> u32 { 0 }
fn default_prevent_proxy_connections() -> bool { false }
fn default_enable_chat_preview() -> bool { false }
fn default_enable_pvp() -> bool { false }
fn default_rate_limit() -> i16 { 0 }
fn default_resource_pack_uri() -> Option<String> { None }
fn default_resource_pack_prompt() -> Option<String> { None }
fn default_resource_pack_sha1() -> Option<String> { None }
fn default_resource_pack_required() -> bool { false }
fn default_ip() -> Option<String> { None }
fn default_port() -> u16 { 25565 }
fn default_simulation_distance() -> u8 { 10 }
fn default_enable_snooper() -> bool { false }
fn default_spawn_animals() -> bool { true }
fn default_spawn_monsters() -> bool { true }
fn default_spawn_npcs() -> bool { true }
fn default_spawn_protection() -> u32 { 16 }
fn default_sync_chunk_writes() -> bool { true }
fn default_use_native_transport() -> bool { true }
fn default_view_distance() -> u8 { 10 }
...
pub fn create_keys(
	...
	let after_18w42a = VersionPattern::After(String::from("18w42a")).matches_single(version, versions);

	out.insert(String::from("allow-flight"), options.allow_flight.to_string());
	out.insert(String::from("allow-nether"), options.world.allow_nether.to_string());
	out.insert(String::from("broadcast-console-to-ops"), options.broadcast_console_to_ops.to_string());
	out.insert(String::from("broadcast-rcon-to-ops"), options.broadcast_rcon_to_ops.to_string());
	out.insert(String::from("difficulty"), if after_18w42a {
		options.difficulty.to_string()
	} else {
		options.difficulty.to_int().to_string()
	});
	out.insert(String::from("enable-command-block"), options.allow_command_blocks.to_string());
	out.insert(String::from("enable-jmx-monitoring"), options.jmx_monitoring.to_string());
	out.insert(String::from("enable-rcon"), options.rcon.enable.to_string());
	out.insert(String::from("enable-status"), options.enable_status.to_string());
	out.insert(String::from("enable-query"), options.query.enable.to_string());
	out.insert(String::from("enforce-secure-profile"), options.enforce_secure_profile.to_string());
	out.insert(String::from("enforce-whitelist"), options.whitelist.enforce.to_string());
	out.insert(String::from("entity-broadcast-range-percentage"), options.entity_broadcast_range.to_string());
	out.insert(String::from("force-gamemode"), options.gamemode.force.to_string());
	out.insert(String::from("function-permission-level"), options.datapacks.function_permission_level.to_string());
	out.insert(String::from("gamemode"), if after_18w42a {
		options.gamemode.default.to_string()
	} else {
		options.gamemode.default.to_int().to_string()
	});
	out.insert(String::from("generate-structures"), options.world.structures.to_string());
	out.insert(
	...
	out.insert(String::from("hide-online-players"), options.hide_online_players.to_string());
	out.insert(String::from("initial-disabled-packs"), write_datapacks(&options.datapacks.initial_disabled));
	out.insert(String::from("initial-enabled-packs"), write_datapacks(&options.datapacks.initial_enabled));
	out.insert(String::from("level-name"), options.world.name.clone());
	out.insert(String::from("level-seed"), options.world.seed.clone().unwrap_or_default());
	out.insert(String::from("level-type"), options.world.r#type.to_string());
	out.insert(String::from("max-chained-neighbor-updates"), options.max_chained_neighbor_updates.to_string());
	out.insert(String::from("max-players"), options.max_players.to_string());
	out.insert(String::from("max-tick-time"), options.max_tick_time.to_string());
	out.insert(String::from("max-build-height"), options.world.max_build_height.to_string());
	out.insert(String::from("max-world-size"), options.world.max_size.to_string());
	out.insert(String::from("motd"), options.motd.clone());
	out.insert(String::from("network-compression-threshold"), options.network_compression_threshold.to_int().to_string());
	out.insert(String::from("online-mode"), (!options.offline_mode).to_string());
	out.insert(String::from("op-permission-level"), options.op_permission_level.to_string());
	out.insert(String::from("player-idle-timeout"), options.player_idle_timeout.to_string());
	out.insert(String::from("prevent-proxy-connections"), options.prevent_proxy_connections.to_string());
	out.insert(String::from("previews-chat"), options.enable_chat_preview.to_string());
	...
	out.insert(String::from("rcon.password"), options.rcon.password.clone().unwrap_or_default());
	out.insert(String::from("rcon.port"), options.rcon.port.to_string());
	out.insert(String::from("resource-pack"), options.resource_pack.uri.clone().unwrap_or_default());
	out.insert(String::from("resource-pack-prompt"), options.resource_pack.prompt.clone().unwrap_or_default());
	out.insert(String::from("require-resource-pack"), options.resource_pack.required.to_string());
	out.insert(String::from("server-ip"), options.ip.clone().unwrap_or_default());
	out.insert(String::from("server-port"), options.port.to_string());
	out.insert(String::from("simulation-distance"), options.simulation_distance.to_string());
	out.insert(String::from("snooper-enabled"), options.enable_snooper.to_string());
	out.insert(String::from("spawn-animals"), options.spawn_animals.to_string());
	out.insert(String::from("spawn-monsters"), options.spawn_monsters.to_string());
	out.insert(String::from("spawn-npcs"), options.spawn_npcs.to_string());
	out.insert(String::from("spawn-protection"), options.spawn_protection.to_string());
	out.insert(String::from("use-native-transport"), options.use_native_transport.to_string());
	out.insert(String::from("view-distance"), options.view_distance.to_string());
	out.insert(String::from("white-list"), options.whitelist.enable.to_string());
